...
def actual_map(request):
	return render(request, "actual_map.html")
...
# RETURN:       no return
#========================================================================================
	mymap.addpoint(47, 28.55, "#00FF00")
...
#========================================================================================
	mymap.draw('templates/actual_map.html')
